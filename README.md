...
* Run a Frank. You can find the Frank!Start view in the explorer. When having a file of a specific Frank open in your editor, you will be able to run this Frank in the Frank!Start view. You can choose to run it with Ant or Docker Compose. If a build.xml/compose file is not present in the Frank you're trying to run, you will be prompted to automatically add one.
