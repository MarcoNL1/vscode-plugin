...
exports.FrankRenameHintProvider = void 0;
    ...
    register(context) {
        ...
        const selectionChangeListener = vscode.window.onDidChangeTextEditorSelection(event => {
            ...
            if (showHint) {
                ...
                const range = new vscode.Range(position.line, lineText.length, position.line, lineText.length);
...
exports.FrankRenameHintProvider = FrankRenameHintProvider;
//# sourceMappingURL=frankRenameHintProvider.js.map