...
suite('MasterRenameProvider Test Suite', () => {
    const provider = new masterRenameProvider_1.MasterRenameProvider();
    ...
    test('prepareRename - throws for cursor on tag name (outside any attribute value)', () => {
        ...
        assert.throws(() => provider.prepareRename(doc, position, {}), /Invalid rename location/);
    });
...
//# sourceMappingURL=masterRenameProvider.test.js.map